...
private:
    ...
    GLfloat vertices[900];   // 50 * 2 * 3 * 3
    GLfloat colors[900];     // 50 * 2 * 3 * 3
    GLfloat texcoords[600];   // 50 * 2 * 3 * 2
    GLfloat normals[900];    // 50 * 2 * 3 * 3
    ...
    void createBuffers() {
        ...
        // reserve space for texture coordinates: for InClass08
    ...
    void updateBuffers() {
        ...
        for (int i = 0; i < numSubdiv; i++) {
            ...
            normals[j + 3] = cos(theta);
            normals[j + 4] = 0.0f;
            normals[j + 5] = sin(theta);
            ...
            normals[j + 9] = normals[j + 6];
            normals[j + 10] = normals[j + 7];
            normals[j + 11] = normals[j + 8];
            ...
            normals[j + 12] = normals[j + 3];
            normals[j + 13] = normals[j + 4];
            normals[j + 14] = normals[j + 5];
            ...
            normals[j + 15] = cos(phi);
            normals[j + 16] = 0.0f;
            normals[j + 17] = sin(phi);
